#include "openref_boot_state_store_fg23.h"

#include <stddef.h>

#ifdef OPENREF_APP_BOOT_STATE_NVM3

#include "nvm3_default.h"

#define OPENREF_BOOT_STATE_SLOT_A_NVM3_KEY ((nvm3_ObjectKey_t)0x0f5220u)
#define OPENREF_BOOT_STATE_SLOT_B_NVM3_KEY ((nvm3_ObjectKey_t)0x0f5221u)
...
static bool slot_key(uint8_t slot, nvm3_ObjectKey_t *key)
{
    ...
    *key = slot == 0u ? OPENREF_BOOT_STATE_SLOT_A_NVM3_KEY
                      : OPENREF_BOOT_STATE_SLOT_B_NVM3_KEY;
    return true;
}
...
openref_config_backend_t openref_boot_state_store_fg23_backend(void)
{
